...
class LoginRegisterController extends Controller
{
    ...
    public function login(Request $request) // Perbaikan: tambahkan parameter $request
    {
    ...
    public function logout(Request $request) // Perbaikan: gunakan $request dengan huruf kecil
    {
        Auth::logout();
